...
const ImageHero = () => {
  ...
  const layouts = [
    ...
    ["col-span-2 row-span-2", "col-start-3 col-span-2", "col-start-3 col-span-2 row-start-2"],
    ["col-span-2 row-span-2", "col-start-3 col-span-2", "pt-5 col-start-3 row-start-2", "col-start-4 row-start-2"]
  ];
