        ...
        <div className="flex justify-between w-[100vw] fixed bg-white top-[0px] h-[100px] border-b items-center p-3 z-[1000] drop-shadow-sm">
          ...
          <div className="flex justify-center w-full z-[10000]">
            <div className="font-Maxeville flex cursor-pointer justify-center">
              <div
                className={`bg-chocolate-main text-white font-bold text-[18px] h-[30px] flex items-center lg:pe-[50px] lg:ps-[50px] xs:px-[20px] rounded-l-full transition-all
            ...
            ${current === "logo"
              ...
              <div
                className={`bg-chocolate-main text-white text-[18px] h-[30px] flex items-center transition-all xs:hidden lg:block
            ${current === "discover"
            ...
            ${current === "connectWallet" ? "rounded-r-full" : ""}
            ${current === "groups"
                    ? "rounded-full px-[28px] mx-[2px]"
                    : "px-[30px]"
                  }
                ...
                <>
                  <div
                    className={`relative bg-chocolate-main text-white text-[18px] h-[30px] flex items-center transition-all xs:px-[10px] lg:px-[30px] 
                      ${current === "logo" ? "lg:rounded-none xs:rounded-l-full" : ""}
                      ${current === "alert" ? "rounded-r-full px-[30px] hover:after:rounded-r-full" : ""}
                      ${current === "groups" ? "lg:rounded-l-full xs:rounded-none" : ""}
                      ${current === "connectWallet" ? "lg:rounded-l-full xs:rounded-none" : ""}
                      ${current === "wallet"
                        ? "rounded-full px-[28px] mx-[2px]"
                        : "px-[30px]"
                      }
                       ${chainID === 11155111 && "hover:after:content-['Sepolia']"}
                  ...
                  >
                    <div >
                      {Number(balance?.formatted).toFixed(3)} <span className="hidden lg:inline">{balance?.symbol}</span>
                    </div>
                  </div>
                  <div
                    className={`${user && "rounded-r-full"} bg-chocolate-main text-white text-[18px] h-[30px] flex items-center transition-all xs:px-[20px] lg:px-[30px]
            ...
            `}
                  ...
                  >
                    <div
                      className={`${user && "bg-white"} bg-chocolate-main text-white text-[18px] h-[30px] flex items-center rounded-r-full transition-all
              ...
              }
              {
                openConnectModal &&
                <div
                  className={`bg-chocolate-main text-white text-[18px] h-[30px] flex items-center transition-all rounded-r-full
                  ...
                  `}
                  onClick={() => { setCurrent("connectWallet"); openConnectModal(); }}
                >
                  Connect Wallet
                </div>
              }
