          ...
          {MyGroupData?.length ? (
            ...
            <div className="flex items-center justify-center mt-5 min-h-[150px]">
              <button
                ...
                className="border border-black rounded-full pl-4 pr-4 w-[350px] text-[18px] mb-[5px] text-center flex items-center justify-center bg-white text-black hover:bg-black hover:text-white transition-all"
              >
                CREATE NEW GROUP
              </button>
            </div>
